...
Contracciones comparables en tiempos de paz en otros países han estado impulsadas sobre todo por la emigración (por ejemplo, Venezuela)~\citep{garcia2019}.
...
& Encuentros de cubanos registrados en EE.UU., 2021 / 2022 & 54\,818 / 313\,506 & externo \\
...
Usamos la cifra publicada, pero el total previo a la revisión elevaría la mortalidad en exceso de 2022 de $\sim$12\,800 a $\sim$21\,900, y el total pospandémico 2022--2025 de $\sim$74\,900 a $\sim$84\,100.
...
La envolvente encabeza la lectura, pero no por ser más ancha: la banda del 90\% del escenario central (0.90~M de amplitud sobre el stock de fin de 2025) es de hecho \emph{más ancha} que la envolvente entre escenarios (0.82~M) y se extiende más allá de ambos extremos. Las dos miden cosas distintas ---la banda es una dispersión predictiva a priori condicional a un conjunto de supuestos, la envolvente es el rango entre conjuntos de supuestos--- y la envolvente encabeza porque lo que realmente determina la respuesta es el desacuerdo sobre los supuestos, no el muestreo dentro de ellos.
