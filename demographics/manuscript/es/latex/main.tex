...
La estandarización por causas solo es posible para 2021--2022, usando la propia submisión CIE-10 de Cuba a la OMS sobre denominadores de la ONEI 3.3, y la reportamos porque uno de sus resultados va en contra del encuadre anterior.
...
En términos comparables, la mortalidad cubana por cardiopatía isquémica está \emph{por debajo} de la cifra regional que suele oponérsele (estandarizada 87.2 por 100\,000 frente a $\sim$105), y su tasa cerebrovascular es unas 1.5 veces la base regional y no las 27 veces que resultan de comparar una tasa cubana específica de 75 y más con una tasa regional de todas las edades.
La mortalidad estandarizada por diabetes además \emph{cayó} un 36\% y la de neoplasias un 6\% entre 2021 y 2022.
No leemos esas caídas como mejora ---2021 es un pico pandémico, y las causas dependientes del diagnóstico se vuelven menos visibles cuando la capacidad diagnóstica falla--- pero tampoco las leemos como corroboración, y señalamos que la proporción de causas mal definidas (R00--R99, 0.87--0.98\%) es estable en el período, lo que es evidencia \emph{en contra} de un deterioro de la certificación.
