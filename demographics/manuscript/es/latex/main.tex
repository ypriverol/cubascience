...
Contracciones comparables en tiempos de paz en otros países han estado impulsadas sobre todo por la emigración (por ejemplo, Venezuela)~\citep{diazbriquets2014}.
...
& Efecto del tamaño poblacional, 2025 & $-$19\,500 & derivado \\
...
Una revisión sistemática de la serie publicada (\texttt{scripts/consistency\_model.py}) devuelve 18 pruebas, de las cuales 7 fallan con severidad alta: dos de ellas (T2, los tres totales oficiales en conflicto para 2022 ---129\,049, 120\,098 y 120\,108, una dispersión del 7.5\%; los totales de 2023 difieren en solo diez defunciones y no son materiales--- y T4, la contradicción de 2023 entre tasa y denominador) usan únicamente fuentes oficiales, de modo que esas inconsistencias son internas a la serie publicada por la ONEI.
...
Un diagnóstico sí sobrevive, con un límite de alcance que importa: las causas mal definidas (R00--R99) se mantienen en 0.85--0.98\% entre 2021 y 2023, lo que es evidencia contra un deterioro de la certificación \emph{en esos años}. No existen datos por causa para 2024--2025, donde se concentra el exceso, de modo que la deriva de codificación en justamente los años que gobiernan el titular queda sin comprobar.
