...
Verificamos que eso era todo lo que hacía la simulación: un Monte Carlo sobre las mismas marginales coincide con la forma cerrada dentro de unas mil personas (1\,117 en el escenario superior), que es ruido de semilla con media cero y no una brecha sistemática: entre semillas la diferencia cambia de signo.
...
La mortalidad se trata como un estimando separado del recuento, y la pregunta que responde también es distinta: ¿qué parte del alza de las defunciones se explica porque la población residente es más vieja, y qué parte no?
...
Junto a ese recuento ---de cuya brecha de 2.53~millones, 1.68~millones son caída ya publicada por la ONEI y 0.85~millones la corrección de este trabajo--- el exceso respecto de la tabla de 2019 corre a $\sim$28\,500 defunciones al año a niveles de 2025 y a $\sim$74\,900 acumuladas en 2022--2025, un costo mayor que lo que explica el envejecimiento por sí solo y alrededor de un tercio inferior a lo que implicaba para 2024--2025 el puente basado en tasas brutas.
