...
descomposición del exceso de mortalidad y triangulación de registros independientes  
...
Cada escenario son tres números, y la cifra puntual es la aritmética anterior evaluada en sus medias a priori, exacta porque la identidad es lineal en las tres. Lo verificamos: un Monte Carlo sobre las mismas marginales coincide con la forma cerrada dentro de unas mil personas (1 117 en el escenario superior), ruido de semilla con media cero y no una brecha sistemática—entre semillas la diferencia cambia de signo. Por eso la cópula se ha eliminado: movía la mediana unas 2 200 personas y solo ensanchaba una banda interna que no es nuestro enunciado primario de incertidumbre. Se conserva un muestreo reducido ($`N=2\times10^5`$, marginales independientes) únicamente para reportar esa banda, que sigue siendo una dispersión *predictiva a priori* y no error muestral. La **envolvente entre escenarios** es el enunciado primario (Pérez-Riverol 2026a, 2026b).

Definimos tres escenarios. El **conservador** añade una corrección modesta. *No* es una cota inferior consistente con la ONEI: su $`M`$ medio es 1.089, un 9% más de emigración que la reportada. El caso de corrección cero es el escenario nulo. El **central** eleva el prior migratorio por encima de la ONEI y acota el subregistro de defunciones al 9%, apenas por encima del 7.5% que el propio registro perdió en 2022 sin explicación. El **superior** define el techo de la envolvente. Se han retirado otros dos conjuntos de priores: una variante ajustada por crisis quedaba a 0.02 millones del escenario central —el mismo escenario con otros diales— y un acompañante de reconstrucción vital basado en un índice ponderado a mano ha sido superado por la descomposición del exceso de mortalidad, que estima la misma cantidad a partir de datos por edad observados y no de una puntuación adimensional. Son **escenarios** (narrativas a priori), no estimadores identificados de una población viva única. Las revisiones de la ONEI de 2023–2024 ya absorbieron un stock rezagado grande, de modo que escalar el $`R`$ revisado por $`M>1`$ *y* restar un $`U_0`$ grande puede contar dos veces el mismo defecto; por eso reportamos siempre el piso junto al central y tratamos $`U_0+(M-1)R`$ como acotado por los pisos de destino más el rezago del registro.
...
El piso de destinos bajo concepto de asentamiento (Cuadro <a href="#tab:bridge" data-reference-type="ref" data-reference="tab:bridge">2</a>) comprende Estados Unidos $`\sim`$<!-- -->800 000 (estatus administrativos / flujo CBP, *no* el stock de la ACS), total no estadounidense $`\sim`$<!-- -->250 000 (España $`\sim`$<!-- -->135 000 + Uruguay $`\sim`$<!-- -->35 000 + resto $`\sim`$<!-- -->80 000), y un piso de $`\sim`$<!-- -->1.05 millones (Pérez-Riverol 2026d). Pew Research Center (2023) se cita solo como contexto basado en la ACS sobre la población asentada de origen cubano; es un concepto distinto de los estatus administrativos anteriores y no es la fuente de los $`\sim`$<!-- -->800 000. El stock de nacidos en Cuba de la ACS creció solo $`\sim`$<!-- -->335 000 entre 2019 y 2024, un piso menor de cambio de stock que no debe igualarse en silencio con la cifra administrativa de 800 000. Los conteos de encuentros y las solicitudes de nacionalidad son conceptos distintos y nunca se suman al piso de asentados (U.S. Customs and Border Protection 2024).
...
<td style="text-align: left;">Piso de destinos asentados, ensamblado por los autores</td>
...
<tr>
<td style="text-align: left;"></td>
<td style="text-align: left;">Encuentros de cubanos registrados en EE.UU., 2021 / 2022 (año natural)</td>
<td style="text-align: right;">54 818 / <span class="math inline">∼</span>313 500</td>
<td style="text-align: left;">compilado</td>
</tr>
<tr>
<td style="text-align: left;"></td>
...
<tr>
<td style="text-align: left;"></td>
<td style="text-align: left;">basados en la aritmética de la propia ONEI</td>
<td style="text-align: right;">2 de 18</td>
<td style="text-align: left;">auditoría</td>
</tr>
<tr>
<td colspan="4" style="text-align: left;"><em>Mortalidad respecto de la tabla de tasas por edad de 2019</em></td>
</tr>
<tr>
<td style="text-align: left;"></td>
...
<tr>
<td style="text-align: left;"></td>
<td style="text-align: left;">incluyendo no registradas estimadas (<span class="math inline">×<em>D</em><sub>fac</sub></span>)</td>
...
<td style="text-align: left;">derivado (estructura proyectada)</td>
</tr>
<tr>
<td style="text-align: left;"></td>
...
<td style="text-align: right;">74 900 [47 000–103 100]</td>
<td style="text-align: left;">valor de escenario</td>
</tr>
<tr>
<td style="text-align: left;"></td>
...
<td style="text-align: right;"><span class="math inline">∼</span>83 800</td>
<td style="text-align: left;">sensibilidad</td>
</tr>
<tr>
<td style="text-align: left;"></td>
...
<td style="text-align: right;"><span class="math inline">−</span>19 500</td>
<td style="text-align: left;">dependiente del escenario</td>
</tr>
<tr>
<td style="text-align: left;"></td>
<td style="text-align: left;">Razón de mortalidad estandarizada vs 2019, 2025</td>
<td style="text-align: right;">1.215</td>
<td style="text-align: left;">derivado (solo registradas)</td>
</tr>
<tr>
<td style="text-align: left;"></td>
...
<tr>
<td style="text-align: left;"></td>
<td style="text-align: left;">Retiro del registro en 2022</td>
<td style="text-align: right;">8 951 (7.5%)</td>
<td style="text-align: left;">reportado</td>
</tr>
<tr>
...
<tr>
<td style="text-align: left;"></td>
<td style="text-align: left;">Participación de la emigración en la brecha, incl. rezago previo a 2021</td>
...
La participación electoral cayó abruptamente entre 2018 y 2023; ese patrón es compatible con ausencia física pero también con abstención, logística y factores políticos, y *no* se usa como recuento de personas.
...
Crecimiento poblacional anual: Cuba frente a la región (aproximado, redondeado). **La procedencia de las filas difiere y la comparación no es equivalente:** las filas de los pares son promedios plurianuales de la revisión 2024 de WPP de la ONU (United Nations, Department of Economic and Social Affairs, Population Division 2024), mientras que la de Cuba es un cambio de un solo año sobre la serie oficial revisada de la ONEI (9 748 007 a 9 434 593), situado justo después de una discontinuidad de revisión del registro. El propio WPP sitúa a Cuba cerca de 10.9 M y no produciría esta fila. Léase la cifra de Cuba como el ritmo reciente de la propia trayectoria oficial, no como una tasa comparable con WPP.
...
<div id="ref-albizu2023le" class="csl-entry">

Albizu-Campos Espiñeira, Juan Carlos. 2023. *La Caída de La Esperanza de Vida Al Nacer En Cuba. De La Crisis Sanitaria a La Humanitaria*. Horizonte Cubano. Cuba Capacity Building Project, Columbia Law School. <https://horizontecubano.law.columbia.edu/news/la-caida-de-la-esperanza-de-vida-al-nacer-en-cuba-de-la-crisis-sanitaria-la-humanitaria>.

</div>

<div id="ref-albizu2024" class="csl-entry">

Albizu-Campos Espiñeira, Juan Carlos. 2024. *Cuba. Una rápida Mirada a La Emigración y La Población*. Horizonte Cubano. Cuba Capacity Building Project, Columbia Law School. <https://horizontecubano.law.columbia.edu/news/cuba-una-rapida-mirada-la-emigracion-y-la-poblacion>.

</div>

<div id="ref-albizu2025" class="csl-entry">

Albizu-Campos Espiñeira, Juan Carlos. 2025. *Cuba: Demographic or Systemic Crisis?* Horizonte Cubano. Cuba Capacity Building Project, Columbia Law School. <https://horizontecubano.law.columbia.edu/news/cuba-demographic-or-systemic-crisis>.

</div>

<div id="ref-press_register_2022" class="csl-entry">

Barrenechea, José Gabriel. 2023. *El Extraño Caso de Los 9 Mil Muertos Desaparecidos En Cuba*. Latinoamérica 21, published in El Universal. <https://www.eluniversal.com.mx/opinion/latinoamerica21/el-extrano-caso-de-los-9-mil-muertos-desaparecidos-en-cuba/>.
...
Pew Research Center. 2023. *Facts on Hispanics of Cuban Origin in the United States, 2021*. Pew Research Center, Race and Ethnicity fact sheet. <https://www.pewresearch.org/race-and-ethnicity/fact-sheet/u-s-hispanics-facts-on-cuban-origin-latinos/>.
...
U.S. Customs and Border Protection. 2024. *Nationwide Encounters*. CBP Enforcement Statistics; Cuba obtained as a citizenship filter. <https://www.cbp.gov/newsroom/stats/nationwide-encounters>.
...
<div id="ref-who_mortality_db" class="csl-entry">

World Health Organization. 2026. *WHO Mortality Database: Cuba, ICD-10 Detailed Tabulation*. WHO Department of Data and Analytics. <https://platform.who.int/mortality>.
