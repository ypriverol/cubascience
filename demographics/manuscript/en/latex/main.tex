...
We verified that this is all the simulation was doing: the closed form and a Monte Carlo over the same margins agree to within about a thousand people (1{,}117 in the upper scenario), which is seed noise with mean zero rather than a systematic gap: across seeds the difference changes sign.
...
Mortality is treated as a separate estimand from the headcount, and the question it answers is separate too: how much of the rise in deaths is explained by the resident population being older, and how much is not?
...
Alongside that headcount---of whose 2.53~million gap 1.68~million is ONEI's own published decline and 0.85~million this paper's correction---excess mortality against the 2019 schedule runs at $\sim$28{,}500 deaths a year at 2025 levels and $\sim$74{,}900 cumulatively over 2022--2025, a toll larger than what ageing alone explains and about a third below what the crude bridge previously implied for 2024--2025.
