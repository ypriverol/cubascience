...
Comparable peacetime contractions elsewhere have been driven primarily by emigration (e.g.\ Venezuela)~\citep{diazbriquets2014}.
...
& Population-size effect, 2025 & $-$19{,}500 & derived \\
...
A systematic pass over the published series (\texttt{scripts/consistency\_model.py}) returns 18 tests, of which 7 fail at high severity: two of them (T2, the three conflicting official totals for 2022---129{,}049, 120{,}098 and 120{,}108, a 7.5\% spread; the 2023 totals differ by only ten deaths and are not material---and T4, the 2023 rate-versus-denominator contradiction) use only official sources, so those inconsistencies are internal to ONEI's own published series.
...
One diagnostic does survive, with a scope limit that matters: ill-defined causes (R00--R99) hold at 0.85--0.98\% across 2021--2023, which is evidence against certification deterioration \emph{in those years}. No cause data exist for 2024--2025, where the excess is concentrated, so coding drift in exactly the years that drive the headline remains untested.
...
Official life expectancy at birth peaked in 2011--13 (78.5 years) and fell to 77.7 in 2018--20; an independent 2021 estimate places it near 71 years~\citep{albizu2023le}. That figure is the lowest of the circulating independent values---the same author's more widely reported 2021 value is 73.7---so it should be read as the low end, not a consensus. The long-run Cuban series is analysed in~\citet{bronnum2023}, which covers 1955--2020 and does not extend to 2021.
